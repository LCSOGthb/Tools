...
export const TOOLS_BY_SLUG = new Map<string, ToolDefinition>(ALL_TOOLS.map((t) => [t.slug, t]));
...
export function getCategoriesWithTools(): Array<ToolCategoryMeta & { tools: ToolDefinition[]; ready: number }> {
