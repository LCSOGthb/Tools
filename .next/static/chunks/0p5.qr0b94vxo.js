    ...
    async function ep(e, t) {
      ...
      try {
        ...
        let _ = (0, f.createHrefFromUrl)(s),
          ...
          w = null !== m && m.includes(o.NEXT_URL),
        ...
        if (j) {
          ...
          if (null === R) return (el(e, Date.now() + 1e4), null);
          ...
          !(function (e, t, r, n, a, u, i, l, s, c, f) {
            ...
            let _ = y.tree,
              m = "1" === r.headers.get(o.NEXT_DID_POSTPONE_HEADER),
              E = { metadataVaryPath: null },
              v = ec(_, d, E),
              R = E.metadataVaryPath;
            if (null === R) return el(a, e + 1e4);
            (0, S.discoverKnownRoute)(e, c, f, a, v, R, u, i, l, !1);
    ...
    async function eh(e, t, r, n) {
      ...
      try {
        ...
        let r = (0, R.createPromiseWithResolvers)(),
          { stream: u, size: i } = await eR(e.body);
    ...
    async function R(e, t) {
      ...
      try {
        let t = await O(e, a, "auto", !0),
          ...
          l = !!t.headers.get(o.NEXT_DID_POSTPONE_HEADER);
        ...
        null === s && (s = T(t.body, a, { allowPartialStream: l }));
            ...
            2 !== c &&
              ...
              ((p = w(
                (i = (function (e, t, r, n) {
                  ...
                  return (
                    (o.refreshState = { canonicalUrl: a, renderedSearch: u }),
                    o
                  );
                })(u, n, E, l)),
              )),
...
${t}`
  ...
  - Rerun the production build with \`next build --debug-prerender\` to generate better stack traces.`));
    ...
    function eo(e, t, r, n) {
      if (n.syncDynamicErrorWithStack)
        throw (
          ei(e, n.syncDynamicErrorWithStack),
          new c.StaticGenBailoutError()
        );
      if (0 !== t) {
