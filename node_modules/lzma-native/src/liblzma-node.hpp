...
// See e.g. http://svn.boost.org/trac/boost/ticket/8092
    ...
    (__APPLE__ && (__GNUC_LIBSTD__ <= 4) && (__GNUC_LIBSTD_MINOR__ <= 2))
 ...
 */
template <typename T> inline Local<String> NewString(T value) {
...
public:
  ...
  void Execute() { stream->doLZMACodeFromAsync(); }

private:
  void HandleOKCallback() { stream->invokeBufferHandlers(false); }

  void HandleErrorCallback() { stream->invokeBufferHandlers(false); }
