...
template <typename T> class TypedArrayContents {
public:
...
// using 7.8 till 13.2.0.
      ...
      data =
          static_cast<char *>(buffer->GetBackingStore()->Data()) + byte_offset;
#else
    ...
    if (from->IsObject() && !from->IsNull()) {
      ...
      if (!buffer.IsEmpty() && !byte_length.IsEmpty() &&
          byte_length.ToLocalChecked()->IsUint32() && !byte_offset.IsEmpty() &&
