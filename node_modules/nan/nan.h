 ...
 *
 * Version 2.22.0: current Node 22.9.0, Node 0.12: 0.12.18, Node 0.10: 0.10.48,
 *iojs: 3.3.1
 *
...
class NonCopyablePersistentTraits : public v8::NonCopyablePersistentTraits<T> {
    ...
    (V8_MAJOR_VERSION > 10 ||                                                  \
     (V8_MAJOR_VERSION == 10 && defined(V8_MINOR_VERSION) &&                   \
      V8_MINOR_VERSION >= 5))
...
template <typename T> class PersistentBase : public v8::PersistentBase<T> {};
...
private:
  ...
  template <typename U> friend Maybe<U> Just(const U &u);
};

template <typename T> inline Maybe<T> Nothing() { return Maybe<T>(); }

template <typename T> inline Maybe<T> Just(const T &t) { return Maybe<T>(t); }
...
public:
  ...
  template <typename T> inline v8::Local<T> Escape(v8::Local<T> value) {
...
public:
  ...
  inline v8::Local<v8::Message> Message() const { return try_catch_.Message(); }
...
public:
  ...
  AsyncResource(const char *name,
    ...
    v8::Local<v8::String> name_string = New<v8::String>(name).ToLocalChecked();
  ...
  v8::Isolate::GetCurrent()->SetAddHistogramSampleFunction(cb);
    ...
    (V8_MAJOR_VERSION > 12 ||                                                  \
     (V8_MAJOR_VERSION == 12 && defined(V8_MINOR_VERSION) &&                   \
      V8_MINOR_VERSION >= 7))
NAN_DEPRECATED inline bool IdleNotification(int) { return true; }
...
MakeCallback(v8::Local<v8::Object> target, v8::Local<v8::Function> func,
...
NAN_DEPRECATED inline v8::Local<v8::Value>
MakeCallback(v8::Local<v8::Object> target, v8::Local<v8::String> symbol,
             int argc, v8::Local<v8::Value> *argv) {
#if NODE_MODULE_VERSION < IOJS_3_0_MODULE_VERSION
  EscapableHandleScope scope;
  return scope.Escape(New(node::MakeCallback(v8::Isolate::GetCurrent(), target,
                                             symbol, argc, argv)));
#else
#if NODE_MODULE_VERSION >= NODE_9_0_MODULE_VERSION
  AsyncResource res("nan:makeCallback");
...
NAN_DEPRECATED inline v8::Local<v8::Value>
MakeCallback(v8::Local<v8::Object> target, const char *method, int argc,
             v8::Local<v8::Value> *argv) {
#if NODE_MODULE_VERSION < IOJS_3_0_MODULE_VERSION
  EscapableHandleScope scope;
  return scope.Escape(New(node::MakeCallback(v8::Isolate::GetCurrent(), target,
...
NAN_DEPRECATED inline v8::Local<v8::Value>
NanErrnoException(int errorno, const char *syscall = NULL,
                  const char *message = NULL, const char *path = NULL) {
...
template <typename T> inline T *GetIsolateData(v8::Isolate *isolate) {
...
typedef void NAN_PROPERTY_GETTER_RETURN_TYPE;
    ...
    (V8_MAJOR_VERSION > 12 ||                                                  \
     (V8_MAJOR_VERSION == 12 && defined(V8_MINOR_VERSION) &&                   \
      V8_MINOR_VERSION > 4))
typedef const PropertyCallbackInfo<void> &NAN_PROPERTY_SETTER_ARGS_TYPE;
...
#define NAN_PROPERTY_GETTER(name)                                              \
  Nan::NAN_PROPERTY_GETTER_RETURN_TYPE name(                                   \
      v8::Local<v8::String> property, Nan::NAN_PROPERTY_GETTER_ARGS_TYPE info)
...
#define NAN_PROPERTY_QUERY(name)                                               \
  Nan::NAN_PROPERTY_QUERY_RETURN_TYPE name(                                    \
      v8::Local<v8::String> property, Nan::NAN_PROPERTY_QUERY_ARGS_TYPE info)
#define NAN_INDEX_GETTER(name)                                                 \
  Nan::NAN_INDEX_GETTER_RETURN_TYPE name(uint32_t index,                       \
                                         Nan::NAN_INDEX_GETTER_ARGS_TYPE info)
#define NAN_INDEX_SETTER(name)                                                 \
  Nan::NAN_INDEX_SETTER_RETURN_TYPE name(uint32_t index,                       \
                                         v8::Local<v8::Value> value,           \
...
public:
  ...
  NAN_DEPRECATED inline v8::Local<v8::Value>
  operator()(v8::Local<v8::Object> target, int argc = 0,
  ...
  NAN_DEPRECATED inline v8::Local<v8::Value>
  operator()(int argc = 0, v8::Local<v8::Value> argv[] = 0) const {
#if NODE_MODULE_VERSION > NODE_0_10_MODULE_VERSION
    v8::Isolate *isolate = v8::Isolate::GetCurrent();
    v8::EscapableHandleScope scope(isolate);
#if NODE_MODULE_VERSION >= NODE_9_0_MODULE_VERSION
  ...
  operator()(AsyncResource *resource, int argc = 0,
             v8::Local<v8::Value> argv[] = 0) const {
    return this->Call(argc, argv, resource);
  }

  inline MaybeLocal<v8::Value>
  operator()(AsyncResource *resource, v8::Local<v8::Object> target,
  ...
  NAN_DEPRECATED inline v8::Local<v8::Value>
  Call(v8::Local<v8::Object> target, int argc,
...
private:
...
#elif NODE_MODULE_VERSION > NODE_0_10_MODULE_VERSION
  v8::Local<v8::Value> Call_(v8::Isolate *isolate, v8::Local<v8::Object> target,
  ...
  v8::Local<v8::Value> Call_(v8::Local<v8::Object> target, int argc,
    ...
    v8::Local<v8::Function> callback = New(handle_);
    return scope.Escape(New(node::MakeCallback(target, callback, argc, argv)));
  }
#endif
};
...
inline MaybeLocal<v8::Value> Call(v8::Local<v8::String> symbol,
  ...
  if (fn_v.IsEmpty() || !fn_v->IsFunction())
...
public:
  ...
  inline v8::Local<v8::Value> GetFromPersistent(const char *key) const {
    EscapableHandleScope scope;
    return scope.Escape(Get(New(persistentHandle), New(key).ToLocalChecked())
                            .FromMaybe(v8::Local<v8::Value>()));
  }
  ...
  inline v8::Local<v8::Value> GetFromPersistent(uint32_t index) const {
    EscapableHandleScope scope;
    return scope.Escape(
        Get(New(persistentHandle), index).FromMaybe(v8::Local<v8::Value>()));
  }
...
inline ExternalOneByteStringResource const *
...
inline void
SetPrototypeMethod(v8::Local<v8::FunctionTemplate> recv, const char *name,
                   FunctionCallback callback,
                   v8::Local<v8::Value> data = v8::Local<v8::Value>()) {
  HandleScope scope;
...
NAN_DEPRECATED inline void
SetAccessor(v8::Local<v8::ObjectTemplate> tpl, v8::Local<v8::String> name,
            GetterCallback getter, SetterCallback setter,
            v8::Local<v8::Value> data, v8::AccessControl settings,
            v8::PropertyAttribute attribute, imp::Sig signature) {
  HandleScope scope;
  ...
  if (setter != 0) {
    obj->SetInternalField(imp::kSetterIndex,
...
inline bool SetAccessor(v8::Local<v8::Object> obj, v8::Local<v8::String> name,
  ...
  if (setter) {
    dataobj->SetInternalField(
        imp::kSetterIndex, New<v8::External>(reinterpret_cast<void *>(setter)));
  }
    ...
    (V8_MAJOR_VERSION > 12 ||                                                  \
     (V8_MAJOR_VERSION == 12 && defined(V8_MINOR_VERSION) &&                   \
      V8_MINOR_VERSION >= 5))
  return obj
      ->SetNativeDataProperty(GetCurrentContext(), name, getter_, setter_,
                              dataobj, attribute)
      .FromMaybe(false);
#else
  return obj
...
inline void SetNamedPropertyHandler(
  ...
  if (setter) {
    obj->SetInternalField(imp::kPropertySetterIndex,
                          New<v8::External>(reinterpret_cast<void *>(setter)));
  }

  if (query) {
    obj->SetInternalField(imp::kPropertyQueryIndex,
                          New<v8::External>(reinterpret_cast<void *>(query)));
  }

  if (deleter) {
    obj->SetInternalField(imp::kPropertyDeleterIndex,
...
inline void SetIndexedPropertyHandler(
  ...
  imp::NativeIndexSetter setter_ = setter ? imp::IndexSetterCallbackWrapper : 0;
  ...
  if (setter) {
    obj->SetInternalField(imp::kIndexPropertySetterIndex,
                          New<v8::External>(reinterpret_cast<void *>(setter)));
  }

  if (query) {
    obj->SetInternalField(imp::kIndexPropertyQueryIndex,
                          New<v8::External>(reinterpret_cast<void *>(query)));
  }

  if (deleter) {
    obj->SetInternalField(imp::kIndexPropertyDeleterIndex,
                          New<v8::External>(reinterpret_cast<void *>(deleter)));
  }
...
inline void SetCallHandler(v8::Local<v8::FunctionTemplate> tpl,
  ...
  obj->SetInternalField(imp::kFunctionIndex,
...
inline void
SetCallAsFunctionHandler(v8::Local<v8::ObjectTemplate> tpl,
                         FunctionCallback callback,
                         v8::Local<v8::Value> data = v8::Local<v8::Value>()) {
  HandleScope scope;
