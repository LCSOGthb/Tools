...
private:
  ...
  template <typename S> static void invoke(NAN_WEAK_CALLBACK_SIG_ data);
  template <typename S>
  ...
  static void invoketwofield(NAN_WEAK_TWOFIELD_CALLBACK_SIG_ data);
#endif
  static WeakCallbackInfo *
  unwrapparameter(NAN_WEAK_PARAMETER_CALLBACK_DATA_TYPE_ data);
  static WeakCallbackInfo *
  unwraptwofield(NAN_WEAK_TWOFIELD_CALLBACK_DATA_TYPE_ data);
#endif
};
...
template <typename S>
WeakCallbackInfo<T> *
WeakCallbackInfo<T>::unwrap(NAN_WEAK_CALLBACK_DATA_TYPE_ data) {
...
template <typename P>
inline void
Persistent<T, M>::SetWeak(P *parameter,
...
Persistent<T, M>::SetWeak(P *parameter,
  ...
  if (type == WeakCallbackType::kParameter) {
    ...
    wcbd = new WeakCallbackInfo<P>(
        ...
        internal_fields[0], internal_fields[1]);
    self->SetAlignedPointerInInternalField(0, wcbd);
    v8::PersistentBase<T>::SetPhantom(static_cast<WeakCallbackInfo<P> *>(0),
...
Persistent<T, M>::SetWeak(P *parameter,
  ...
  if (type == WeakCallbackType::kParameter) {
    ...
    wcbd = new WeakCallbackInfo<P>(
        ...
        internal_fields[0], internal_fields[1]);
    self->SetAlignedPointerInInternalField(0, wcbd);
    v8::PersistentBase<T>::SetPhantom(WeakCallbackInfo<P>::invoketwofield, 0,
                                      count > 1 ? 1 : kNoInternalFieldIndex);
  }
}
#elif NODE_MODULE_VERSION > NODE_0_10_MODULE_VERSION
